...
#if WASMEDGE_PLUGIN_WASI_NN_GGML_STRATEGY == PARALLEL
...
int example_main(int argc, char ** argv) {
...

    {
        ...
        for (int32_t i = 0; i < n_tokens_system; ++i) {
            llama_batch_add(batch, tokens_system[i], i, { 0 }, false); // BUG: llama_batch_add is not supported
        }
  ...
  #else
  #endif // if WASMEDGE_PLUGIN_WASI_NN_GGML_STRATEGY == PARALLEL
#endif // ifdef WASMEDGE_PLUGIN_WASI_NN_GGML_STRATEGY